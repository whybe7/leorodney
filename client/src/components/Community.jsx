...
export default function Community({search, loading, prompts, searchResults}) {
  ...
  return (
    <section className="py-5 px-5 md:px-3 md:py-3 sm:py-1 sm:px-1">
        ...
        <>
        {search ? <Cards cards={searchResults} notFound="No search results found..!"/> : <Cards cards={prompts} notFound="No prompts found..!"/>}
        </>
        }
    </section>
  )
