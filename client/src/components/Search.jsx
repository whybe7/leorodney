  ...
  return (
    <div className="w-full flex items-center gap-4">
      <div className="relative w-3/4 flex items-center">
        ...
        <input ref={searchRef} onChange={dynamicRetore} onKeyDown={e=> e.key == "Enter"? handelSearch() : null} id="search" className="w-full pl-12 py-4 rounded-md outline-none focus:ring-2 focus:ring-[var(--blue-clr)] text-black" type={"search"} placeholder="Search in the Community..."/>
